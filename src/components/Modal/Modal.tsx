import { type FormParam, type FormStateType, formInputs } from "../../const";
...
export const Modal = ({
	...
	<dialog
		...
		tabIndex={-1}
		aria-hidden="true"
		className={`overflow-y-auto overflow-x-hidden top-0 right-0 z-50 justify-center items-center h-screen w-screen backdrop-filter:blur-sm backdrop-brightness-50 bg-transparent ${
			isOpen ? "flex" : ""
		}`}
		open={isOpen}
	>
